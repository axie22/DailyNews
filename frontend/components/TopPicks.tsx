  ...
  return (
    <section className="mb-8">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-sm font-semibold text-gray-900 tracking-tight">Top Picks</h2>
        <span className="text-xs text-gray-400">Highest rated this week</span>
      </div>
        ...
        {articles.slice(0, 6).map((a, i) => (
          <Link
            ...
            className={`group block rounded-xl border p-3.5 transition-all hover:shadow-md ${
              i === 0
                ? "sm:col-span-2 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 hover:border-amber-300"
          ...
          >
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-[11px] text-gray-300">{timeAgo(a.published_at)}</span>
            </div>
            <h3 className={`font-semibold leading-snug group-hover:text-blue-600 transition-colors line-clamp-2 ${
